...
{
    MainTableViewHeader *headerView = [MainTableViewHeader mainTableViewHeader];
    if (section == 0) {
        headerView.TitleLabel.text = @"民眾最愛投票區";
    }else if (section == 1){
        headerView.TitleLabel.text = @"投票中任務";
    }
    headerView.BodyLable.text = @" ";
    return headerView;
}
//
